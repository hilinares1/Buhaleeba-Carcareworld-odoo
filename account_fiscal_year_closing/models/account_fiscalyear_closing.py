...
class AccountFiscalyearClosing(models.Model):
    ...
    def _default_year(self):
        ...
        month = str(lock_date.month)
        day = str(lock_date.day)
        fiscalyear = lock_date.year
        if (month and day) and (month < company.fiscalyear_last_month and
                day < company.fiscalyear_last_day):
        # if lock_date.month < company.fiscalyear_  last_month and \
